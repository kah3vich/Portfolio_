	...
	return (
		<Layout title='Home'>
			<div className='containers'>
				<div className='home'>
					<Animation className='home__tb'>
						<p>{homePageMocks.bannerText}</p>
					</Animation>
					<Animation className='home__info' delay={0.4}>
					...
					<Animation className='home__work' delay={0.5}>
					...
					<Animation className='home__bio' delay={0.55}>
					...
					<Animation className='home__like'>
