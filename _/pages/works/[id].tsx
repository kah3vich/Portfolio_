	...
	return (
		<Layout title={work.title}>
			<div className='containers'>
				<div className='work'>
					<AnimationContainer className='work__h'>
						<Link href='/works'>
					...
					<AnimationContainer className='work__d' delay={0.5}>
						<p className='work__description'>{work.description}</p>
					</AnimationContainer>
					<AnimationContainer className='work__i' delay={0.6}>
					...
					<AnimationContainer className='work__photo' delay={0.7}>
						<Image
